...
//
//	// Копируем первый элемент из списка other
//	if (otherCurr != nullptr) {
//		insert_first(otherCurr->data);
//		if (pFirst->data == otherCurr->data) {
//			curr = pFirst;
//		}
//		otherCurr = otherCurr->pNext;
//	}
...
//		otherCurr = otherCurr->pNext;
//	}
//	// Устанавливаем pCurrent на найденный эквивалентный элемент в текущем списке
//	pCurrent = curr;
//
//	return *this;
//}
